...
function ARAgingPage() {
  ...
  const loadReport = async () => {
    const res = await API.get(`/reports/ar-aging?as_of=${asOf}`);
    setRows(res.data || []);
  };
  ...
  return (
    <div>
      <div style={styles.title}>A/R Aging</div>
      <div style={styles.sub}>Customer outstanding aging by invoice date.</div>
