...
const styles = {
  ...
  tableHead: {
    display: "grid",
    gridTemplateColumns: "0.8fr 1.3fr 0.8fr 0.8fr 0.8fr 0.7fr",
    padding: "14px 16px",
    background: "#f8fafc",
    fontSize: 12,
    fontWeight: 700,
...
function ItemsPage() {
  ...
  return (
    <div>
      ...
      <div style={styles.sub}>Manage goods and services used in line-item invoices and stock movement.</div>
